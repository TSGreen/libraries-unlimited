...
\graphicspath{{testing/}{revisedformplots/}{images/}} % Specifies the directory where pictures are stored
...
\center{\includegraphics[width=0.99\linewidth]{PinnedMap-crop}}
...
\begin{figure}[!htb] % Example image
\center{\includegraphics[width=0.6\linewidth]{gender}}
...
\begin{figure}[!htb] % Example image
\center{\includegraphics[width=0.65\linewidth]{AgeDistribution}}
...
\begin{figure}[!htb]
\center{\includegraphics[width=0.9\linewidth]{AppRatings}}
...
\center{\includegraphics[width=0.6\linewidth]{pie_gender}}
...
\begin{figure} % Example image
\center{\includegraphics[width=0.7\linewidth]{AgeDistribution}}
